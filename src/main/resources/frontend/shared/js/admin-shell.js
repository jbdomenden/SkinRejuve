  ...
  sidebar.innerHTML = `
    <div class="admin-sidebar-top">
      ...
      <nav class="admin-nav-list" aria-label="Admin navigation">
        <a href="/frontend/admin/html/admin-dashboard.html" data-admin-nav="dashboard"><span class="admin-nav-icon">${sidebarIcon('dashboard')}</span><span class="admin-nav-copy"><strong>Dashboard</strong><small>Pulse of daily activity</small></span></a>
        <a href="/frontend/admin/html/admin-appointments.html" data-admin-nav="appointments"><span class="admin-nav-icon">${sidebarIcon('appointments')}</span><span class="admin-nav-copy"><strong>Appointments</strong><small>Bookings and queue flow</small></span></a>
        <a href="/frontend/admin/html/admin-registration.html" data-admin-nav="registration"><span class="admin-nav-icon">${sidebarIcon('registration')}</span><span class="admin-nav-copy"><strong>Registration</strong><small>New accounts and intake</small></span></a>
        <a href="/frontend/admin/html/admin-reports.html" data-admin-nav="reports"><span class="admin-nav-icon">${sidebarIcon('reports')}</span><span class="admin-nav-copy"><strong>Audit Log</strong><small>History, reports, and tracking</small></span></a>
        <a href="/frontend/admin/html/admin-landing.html" data-admin-nav="landing"><span class="admin-nav-icon">${sidebarIcon('landing')}</span><span class="admin-nav-copy"><strong>Settings</strong><small>Profile, security, and landing page</small></span></a>
      </nav>
    </div>
